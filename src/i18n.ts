...
const resources = {
  en: {
    translation: {
      ...
      no_abha: "No ABHA",
      registration_disclaimer: "Full registration (identifiers, duplicate check REG-003, referrer capture REF-012) is ticket UI-203/204.",
      ...
      emr_desc: "EMR workflow, SOAP notes templates, and structured prescriptions (EMR-002, RX-002) are under active development.",
  ...
  te: {
    translation: {
      ...
      no_abha: "ABHA లేదు",
      registration_disclaimer: "పూర్తి నమోదు (గుర్తింపులు, నకిలీ తనిఖీ REG-003, రెఫరర్ క్యాప్చర్ REF-012) టికెట్ UI-203/204 కి సంబంధించినది.",
      ...
      emr_desc: "ఈఎంఆర్ వర్క్‌ఫ్లో, SOAP నోట్స్ టెంప్లేట్లు మరియు నిర్మాణాత్మక ప్రిస్క్రిప్షన్లు (EMR-002, RX-002) చురుకైన అభివృద్ధిలో ఉన్నాయి.",
